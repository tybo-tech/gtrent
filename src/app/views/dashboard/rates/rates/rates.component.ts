...
export class RatesComponent implements OnInit {
  ...
  add() {
    this.item = {
      ...
      Name: '',
      ParentId: '',
      ItemType: ITEM_TYPES.PARTS_USED.Name,
      ...
      ImageUrl: '',
      ItemPin: '',
      ItemCategory: ITEM_TYPES.PARTS_USED.Name,
      ItemSubCategory: '',
      CreateUserId: '',
      ModifyUserId: '',
      StatusId: 1
  ...
  getItems() {
    this.itemService.getItems(this.user.CompanyId, ITEM_TYPES.PARTS_USED.Name).subscribe(data => {
      this.items = data || [];
    });
  }
  save() {
