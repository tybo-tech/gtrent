...
import { GET_CUSTOMERS_URL, GET_CUSTOMER_URL, UPDATE_CUSTOMER_URL, ADD_CUSTOMER_URL, GET_CUSTOMER_BY_COMPANY_AND_EMAIL_URL, ADD_CUSTOMER_RANGE_URL } from 'src/shared/constants';
...
export class CustomerService {
  ...
  addRange(customer :  Customer[]) {
    return this.http.post<Customer[]>(`${this.url}/${ADD_CUSTOMER_RANGE_URL}`, customer);
  }
